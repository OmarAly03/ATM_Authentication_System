...
class ATMApp:
    ...
    def screen1(self):
        ...
        start_button = tk.Button(self.frame, text="Press to start", command=self.screen2, font=('Arial', 14))
        start_button.pack(pady=20)

    def reset_inactivity_timer(self):
        if self.inactivity_timer is not None:
            self.root.after_cancel(self.inactivity_timer)
        self.inactivity_timer = self.root.after(self.inactivity_period, self.destroy_root)
    ...
    def screen2(self):
        ...
        next_button = tk.Button(self.frame, text="Next", command=self.submit1, font=('Arial', 14))
    ...
    def screen3(self):
        ...
        label = tk.Label(self.frame, text="Please enter password or use your fingerprint", font=('Arial', 14))
        label.pack(pady=20)
        
        self.password_entry = tk.Entry(self.frame, show='*', font=('Arial', 14))
        self.password_entry.pack(pady=5)
        
        next_button = tk.Button(self.frame, text="Next", command=self.submit2, font=('Arial', 14))
        next_button.pack(pady=20)
    ...
    def authenticate(self):
        ...
        if check:
            ...
            self.trials -= 1
            messagebox.showerror("Authentication Failed", f"Invalid password\nYou have {self.trials} trial(s) left")
            self.screen3()
    ...
    def screen4(self):
        ...
        next_button = tk.Button(self.frame, text="Next", command=self.screen5, font=('Arial', 14))
        next_button.pack(pady=20)
    ...
    def screen5(self):
        ...
        label = tk.Label(self.frame, text="Which service would you like to use today?", font=('Arial', 14))
        label.pack(pady=20)
        
        services = ["Balance","Deposit", "Withdraw", "Show Account Details", "Transfer", "Show Latest Transaction"]
        for service in services:
            button = tk.Button(self.frame, text=service, command=lambda s=service: self.service_action(s), font=('Arial', 12))
            button.pack(pady=5)

        close_button = tk.Button(self.frame, text="Close", command=self.screen6, font=('Arial', 12))
    ...
    def screen_balance(self):
        ...
        label = tk.Label(self.frame, text=f"Your account balance is: {balance}", font=('Arial', 14))
        label.pack(pady=20)
        back_button = tk.Button(self.frame, text="Back", command=self.screen5, font=('Arial', 14))
    ...
    def countdown(self, seconds, message):
        ...
        label.pack(pady=20)
        label = tk.Label(self.frame, text=f"Waiting for {seconds} seconds...", font=('Arial', 14))
    ...
    def screen_deposit1(self):
        ...
        self.amount.pack()
        back_button = tk.Button(self.frame, text="Next", command=self.screen_deposit2, font=('Arial', 14))
        back_button.pack(pady=20)
    ...
    def screen_deposit2(self):
        ...
        result_label = tk.Label(self.frame, text=f"{amount} is Deposited\nUpdated Balance: {self.user1.getAccountBalance()}", font=('Arial', 14))
    ...
    def screen_withdraw1(self):
        ...
        self.amount = tk.Entry(self.frame, font=('Arial', 14))
        self.amount.pack()
        back_button = tk.Button(self.frame, text="Next", command=self.screen_withdraw2, font=('Arial', 14))
        back_button.pack(pady=20)
    ...
    def screen_withdraw2(self):
        ...
        if withdraw_result:       
            result_label = tk.Label(self.frame, text=f"You withdrawed {amount} successfully\nUpdated Balance: {self.user1.getAccountBalance()}", font=('Arial', 14))
            result_label.pack(pady=20)
        else:
            result_label = tk.Label(self.frame, text=f"Insuffecient Amount\nAvailable Balance: {self.user1.getAccountBalance()}", font=('Arial', 14))
            result_label.pack(pady=20)
    ...
    def screen_show_account_details(self):
        ...
        label.pack(pady=20)
        result_label = tk.Label(self.frame, text=f"Your balance is: {self.user1.getAccountBalance()}\nYour account number is: {self.user1.getAccountNumber()}\nYour national ID is: {self.user1.getNationalID()}\nYour phone number is: {self.user1.getPhoneNumber()}", font=('Arial', 14))
        result_label.pack(pady=20)
    ...
    def screen_transfer1(self):
        self.clear_frame()
        label = tk.Label(self.frame, text="Enter the recipient's name", font=('Arial', 18))
        label.pack(pady=20)
        self.username_entry = tk.Entry(self.frame, font=('Arial', 14))
        self.username_entry.pack()
        back_button = tk.Button(self.frame, text="Next", command=self.screen_transfer2, font=('Arial', 14))
        back_button.pack(pady=20)
    ...
    def screen_transfer2(self):
        self.username = self.username_entry.get()
        self.clear_frame()
        label = tk.Label(self.frame, text="Enter the transfer amount", font=('Arial', 18))
        label.pack(pady=20)
        self.amount = tk.Entry(self.frame, font=('Arial', 14))
        self.amount.pack()
        back_button = tk.Button(self.frame, text="Next", command=self.screen_transfer3, font=('Arial', 14))
        back_button.pack(pady=20)
    ...
    def screen_transfer3(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"The entered recipient doesn't exist in the database")
            self.screen5()
            return
